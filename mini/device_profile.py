...
LED_SESSION_PINNED = 37     # BLUE — overrides session-button green while the active sequencer is pinned to a track
LED_SEQUENCER = 96          # AMBER — drum sequencer indicator on User button
LED_MELODIC = 41            # MELODIC sequencer indicator on User button
LED_CHORD = 53              # PURPLE — chord-pad mode indicator on User button
LED_USER_HELD = 3           # WHITE — "User is held, mode selector is up"
