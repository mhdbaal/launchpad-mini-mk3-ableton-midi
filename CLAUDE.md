...
| Custom (96) | **generic native passthrough** (opens native Note layout; device's own Chord/Custom/Sequencer buttons then work natively — doorway to the hardware step sequencer) | idem |
